...
export class Figure {
  ...
  /**
   * Отпустить всё своё: фигура больше не нужна.
   *
   * Главное здесь — скелет. У каждой фигуры он свой (клонируется вместе со
   * скином), а три.js заводит под него текстуру костей в видеопамяти. Геометрия
   * и материалы при этом общие с библиотекой, их трогать нельзя — а вот скелеты
   * копились с каждой загрузкой уровня: полсотни зомби на локацию, и через
   * несколько перезапусков игра ложилась на телефоне.
   */
  dispose() {
